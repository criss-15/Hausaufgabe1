...
public class Aufgabe4 {
     ...
     */
    public static int billigsteTastatur(List<Integer> preiseTastaturen) {
    ...
    /* die Methode gibt den teuersten Gegenstand;
    Input: zwei arrays mit Preise von Tastaturen und USB
    Output: teuersten Gegenstand;
     */
    public static int teuersteGegenstand(List<Integer> listeTastatur, List<Integer> listeUSB){
        int billigsteGegenstand = 0;
        int billigsteTastatur;
        int billigsteUSB;
        billigsteTastatur=billigsteTastatur(listeTastatur);
        billigsteUSB=billigsteTastatur(listeUSB);
     ...
     */
    public static int teuersteUSB(List<Integer> preiseUSB, int buget){
